...
public class DBHelper {
    ...
    public static final String CREATE_TABLE_DRIVERS         = "create table drivers (_id text primary key, description text,hash text, time integer)";
    ...
    public static SQLiteOpenHelper getOpenHelper(final Context context) {
        if (sqLiteOpenHelper == null) {
            sqLiteOpenHelper = new SQLiteOpenHelper(context, DATABASE_NAME, null, 7) {
                @Override
                public void onCreate(SQLiteDatabase db) {
                    ...
                    checkTypes.put(CN_CODE, IFptr.CHEQUE_TYPE_SELL);
                    ...
                    checkTypes.put(CN_CODE, IFptr.CHEQUE_TYPE_RETURN);
